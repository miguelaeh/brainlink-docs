...
<AccordionGroup>
  <Accordion icon="github" title="Register your application with BrainLink">
    ...
    1. Fill the form with the data with your application data. If you have not yet deployed your application, you can use `http://localhost:3000` on the URLs to test
